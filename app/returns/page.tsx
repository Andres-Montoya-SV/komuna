            ...
            <div className="card bg-white border-2 border-primary/10 shadow-lg">
              <div className="card-body">
                ...
                <div className="alert alert-info">
                  ...
                  <span>Please check individual seller return policies before making a purchase.</span>
                </div>
              </div>
            </div>
            ...
            <div className="card bg-white border-2 border-primary/10 shadow-lg">
              <div className="card-body">
                ...
                <p className="text-base-content/80 mb-4">
                  ...
                  within 5-7 business days. The refund will be issued to the original payment method.
                </p>
