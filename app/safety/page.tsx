      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-base-content/70 mb-8">
            Your safety is our priority. Follow these guidelines to have a safe and secure
            experience on Komuna.
          </p>
            ...
            <div className="card bg-error/10 border-2 border-error/20">
              <div className="card-body">
                ...
                <p className="text-base-content/80 mb-4">
                  ...
                  please report it to us immediately. We take all reports seriously and will
