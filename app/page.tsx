        ...
        <div className="container mx-auto px-4 py-6">
          <FadeIn delay={0.1}>
            <div className="text-center mb-4">
              <h1 className="text-3xl font-bold text-primary mb-2">{getTypeLabel(filters.type)}</h1>
              <p className="text-base-content/70">
                Discover and {filters.type === 'job' ? 'find' : 'buy'}{' '}
          ...
          <FadeIn delay={0.2}>
            <div className="flex justify-center">
              <SearchBar onSearch={handleSearch} products={items as any} showLiveResults={true} />
            </div>
          </FadeIn>
          ...
          {cart.length > 0 && (
            ...
            >
              <span className="badge badge-primary badge-lg">
                Cart: {cart.reduce((sum, item) => sum + item.quantity, 0)} item
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              ...
              <div className="flex gap-3">
                <a
                  href="#"
                  className="btn btn-circle btn-sm bg-white/10 border-white/20 hover:bg-white/20"
                >
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="mailto:support@komuna.com"
                    className="text-white/80 hover:text-white transition-colors"
                  >
                    support@komuna.com
                  </a>
