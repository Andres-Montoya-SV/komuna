            ...
            <div className="card-body space-y-6">
              <section>
                ...
                <p className="text-base-content/80 leading-relaxed">
                  By accessing and using Komuna, you accept and agree to be bound by the terms and
              ...
              <section>
                ...
                <p className="text-base-content/80 leading-relaxed mb-3">You may not use Komuna:</p>
                <ul className="list-disc list-inside space-y-2 text-base-content/80 ml-4">
                  <li>
              ...
              <section>
                ...
                <p className="text-base-content/80 leading-relaxed">
                  Komuna may revise these terms of service at any time without notice. By using this
