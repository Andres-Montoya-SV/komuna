          ...
          <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-base-content/80">
                      Delivery within 5-7 business days. Free for orders over $100. $10 for orders
                      under $100.
                    </p>
                  </div>
                  <div>
            ...
            <div className="card bg-white border-2 border-primary/10 shadow-lg">
              <div className="card-body">
                ...
                <p className="text-base-content/80 mb-4">
                  We currently ship to all areas in El Salvador. International shipping may be
                  available for certain items - please contact the seller for details.
                </p>
            ...
            <div className="card bg-white border-2 border-primary/10 shadow-lg">
              <div className="card-body">
                ...
                <p className="text-base-content/80">
                  You can also view your order status and tracking information in your account
