...
describe('FilterPriceRange', () => {
  it('renders price range inputs', () => {
    render(<FilterPriceRange maxPrice={1000} onPriceChange={() => {}} />);
  ...
  it('calls onPriceChange when min price changes', () => {
    ...
    render(<FilterPriceRange maxPrice={1000} maxPriceValue={500} onPriceChange={onPriceChange} />);
  ...
  it('calls onPriceChange when max price changes', () => {
    const onPriceChange = jest.fn();
    render(<FilterPriceRange maxPrice={1000} minPrice={100} onPriceChange={onPriceChange} />);
