...
export default function StoreProductList({ products, onDelete, onUpdate }: StoreProductListProps) {
  ...
  return (
    <div className="card bg-white border-2 border-primary/10 shadow-lg">
      <div className="card-body">
        <h2 className="card-title text-primary mb-4">Your Products ({products.length})</h2>
